    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-lg-9">
                <main id="content" tabindex="-1" class="information ring metal">
                    <div class="page-header">
                        <h2>METAL <small>금속 정보</small></h2>
                    </div>
                    <div class="tabs">
                        <ul>
                    ...
                    <div class="section-content">
                        <div class="type">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="figure">
                                        <p><img class="img-responsive" src="/assets/images/information/img_ring_metal_figure_1.jpg" alt=""></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="details">
                                        ...
                                        <p>
                                            백금은 금보다 단단하며 융점이 높아 작업하기 힘들지만, 형태의 변형이 매우 적기 때문에 다이아몬드에 셋팅시 가장 걸맞는 금속입니다.<br>
                        ...
                        <div class="type">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="figure">
                                        <p><img class="img-responsive" src="/assets/images/information/img_ring_metal_figure_2.jpg" alt=""></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="details">
                        ...
                        <div class="type">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="figure">
                                        <p><img class="img-responsive" src="/assets/images/information/img_ring_metal_figure_3.jpg" alt=""></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="details">
                        ...
                        <div class="type">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="figure">
                                        <p><img class="img-responsive" src="/assets/images/information/img_ring_metal_figure_4.jpg" alt=""></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-8">
                                    <div class="details">
