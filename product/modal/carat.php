...
<div class="modal-body carat">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5">
            <div class="figure">
                <p><img class="img-responsive" src="/assets/images/product/img_help_carat_1.gif" alt=""></p>
            </div>
        </div>
    </div>
    ...
    (function($) {
        $( ".modal .slider > div:eq(0)" ).slider({
            ...
            slide: function(event, ui) {
                $(".modal .figure img").attr('src', '/assets/images/product/img_help_carat_'+(ui.value)+'.gif');
